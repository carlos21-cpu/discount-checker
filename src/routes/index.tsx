...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Portal de Pagos - Control Vehicular" },
      {
        name: "description",
        content:
          "Consulte sus adeudos vehiculares, realice pagos y obtenga constancias de manera rapida y segura.",
      },
    ],
  }),
});
    ...
    <div className="bg-card rounded-xl border border-border shadow-sm p-6 space-y-6">
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <DataField label="NUM. PLACA" value="ABC1234" />
          <DataField label="FOLIO DE PAGO" value="ABC1234L4N" />
        </div>
        <div className="mt-3">
